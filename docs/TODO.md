...
- カテゴリ数: 29
- データ件数:
  - ja: 837件（chineself.com 527件 + devichan-chigoworld.com 310件）
  - en/ko/th: 837件（全データ翻訳済み）

## 📚 データソース

| ソース | 件数 | slug形式 | 備考 |
|--------|------|----------|------|
| chineself.com | 527件 | `tangping`, `neijuan` | 翻訳済み (en/ko/th) |
| devichan-chigoworld.com | 310件 | `devichan-1`〜`devichan-316` | 翻訳済み (en/ko/th) |
...
# devichan-chigoworld.com
node scripts/scrape-devichan.mjs
node scripts/cleanup-devichan.mjs  # データクリーンアップ
```
